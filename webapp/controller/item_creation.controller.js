sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.proyectoItelco.controller.item_creation", {
		handleRouteMatched: function(oEvent) {
			...
			if (!this.sContext) {
				this.sContext = "SafetyItemSet('SI1')";
			}
				...
				.then(function(result) {
					if (result === false) {
						...
						return new Promise(function(fnResolve) {
							...
							this.doNavigate("item_edition", oBindingContext, fnResolve, "");
						}.bind(this));
		...
		onInit: function() {
			...
			this.oRouter.getTarget("item_creation").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "sap_uxap_ObjectPageLayout_0-sections-sap_uxap_ObjectPageSection-1-subSections-sap_uxap_ObjectPageSubSection-1-f472cbe8ef8788600da0e9763_S3-060c52d8fcdb75320da12d244_S4-blocks-build_simple_form_Form-1527649034670-formContainers-build_simple_form_FormContainer-1-formElements-build_simple_form_FormElement-6-fields-sap_m_ComboBox-1",
				"groups": ["items"]
			}];
